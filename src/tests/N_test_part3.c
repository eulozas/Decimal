...
int test_is_equal(s21_decimal d1, s21_decimal d2) {
  for (int i = 0; i < 4; i++) {
...
int test_get_sign(const s21_decimal decimal) {
...
void test_floor(s21_decimal decimal, s21_decimal decimal_check) {
  ...
  int sign_check = test_get_sign(decimal_check);
  int sign_result = test_get_sign(result);

  ck_assert_int_eq(code, 0);
  ck_assert_int_eq(test_is_equal(result, decimal_check), 1);
