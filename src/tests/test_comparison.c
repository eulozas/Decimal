...
START_TEST(test_greater_basic5) {
  s21_decimal a = {{100, 100, 100, 0}}; // +500
  s21_decimal b = {{100, 100, 100, 0}};        // -500
  ck_assert_int_eq(s21_is_greater(a, b), 0);
}
END_TEST
...
START_TEST(test_greater_basic6) {
  ...
  s21_decimal b = {{0x96DCDDCA, 0x5C57756E, 0x1BC00CA7, 0x80070000}};     // -500
  ck_assert_int_eq(s21_is_greater(a, b), 1);
}
END_TEST
