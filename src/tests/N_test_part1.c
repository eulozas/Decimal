...
START_TEST(test_from_float_to_decimal_ok1) {
    ...
    ck_assert_uint_eq(decimal.bits[3]>>31 & 1u, decimal_check.bits[3]>>31 & 1u);
    ck_assert_uint_eq(decimal.bits[3]>>16 & 0xFF, decimal_check.bits[3]>>16 & 0xFF);
    ck_assert_uint_eq(decimal.bits[0], decimal_check.bits[0]);
    ck_assert_uint_eq(decimal.bits[1], decimal_check.bits[1]);
    ck_assert_uint_eq(decimal.bits[2], decimal_check.bits[2]);
...
Suite *from_float_to_decimal_suite8(void) {
    ...
    s = suite_create("from_float_to_decimal_suite8");
    tc_core = tcase_create("Core");

    tcase_add_test(tc_core, test_from_float_to_decimal_unnormal1);
    tcase_add_test(tc_core, test_from_float_to_decimal_fail_big);
    tcase_add_test(tc_core, test_from_float_to_decimal_fail_small);
...
Suite *from_int_to_decimal_suite1(void) {
    ...
    s = suite_create("from_int_to_decimal_suite1");
    tc_core = tcase_create("Core");
